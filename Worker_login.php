...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT WorkerID, Password FROM Worker WHERE Workername=? AND Password=?");
...
<body>
    ...
    <div class="login-container">
        ...
        <form action=" " method="POST">
            ...
            <h2 class="register_button"><a href="Register.php">Don't have an account ? Register here</a></h2>
        </form>
    </div>
</body>
</html>
